...
public class Test {
	public static void main(String[] arg) {
		...
		ParseResult<CompilationUnit> parse = parser.parse("public @interface T {int value() default 4; }");

		AnnotationMemberDeclaration a;
		CompilationUnit cu = parse.getResult().get();
		System.out.println(cu.getTypes().get(0).asAnnotationDeclaration().getMember(0).asAnnotationMemberDeclaration());
